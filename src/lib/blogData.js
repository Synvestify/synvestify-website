export const posts = [
  ...
  excerpt:  'Gold is at ₹1.52 lakh per 10g — near record highs. The Iran war, a weak rupee, and global uncertainty are all in play. Here is what smart investors should actually do on Akshaya Tritiya this year.',
...
They are not separate goals — they are the same goal.
  ...
  },
  {
    ...
    title:    'Your Year-End Financial Review Checklist',
